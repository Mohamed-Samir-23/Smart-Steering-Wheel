...
/*Interrupt Level*/
//GIE ---> NVIC ENABLE ---> PIE
#define MNVIC_PRIORITY_GROUPS_16_SUBGROUPS_0 	0
#define MNVIC_PRIORITY_GROUPS_8_SUBGROUPS_2 	4
#define MNVIC_PRIORITY_GROUPS_4_SUBGROUPS_4 	5
#define MNVIC_PRIORITY_GROUPS_2_SUBGROUPS_8 	6
#define MNVIC_PRIORITY_GROUPS_0_SUBGROUPS_16 	7
