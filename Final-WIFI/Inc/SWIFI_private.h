...
#define SysCaptureKey (!strncmp( ( char *) &WIFI_Buffer[L_Buffer_Count+ 1 -SystemCalls[L_intCounter].Dest_Name_size ] ,( char *) SystemCalls[L_intCounter].Dest_Name,SystemCalls[L_intCounter].Dest_Name_size))
